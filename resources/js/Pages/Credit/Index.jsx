...
import PackagePricingCards from "@/Components/PackagePricingCards.jsx";
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative">
                        <div className="flex flex-col gap-3 items-center p-4">
                            <img src="/asset/file.png" alt="coin" className="w-[100px]"/>
                            <h3 className="text-white text-2xl">You have {availableCredits} credits.</h3>
                        </div>
                    </div>
